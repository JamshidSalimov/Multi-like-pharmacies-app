    ...
    <b-row>
      ...
      >
        <b-form-checkbox
          ...
          inline
        >
          <span>{{$t('Email me when someone comments on my article')}}</span>
        </b-form-checkbox>
      </b-col>
      <b-col
        cols="12"
      ...
      >
        <b-form-checkbox
          ...
          inline
        >
          <span>{{$t('Email me when someone answers on my form')}}</span>
        </b-form-checkbox>
      </b-col>
      <b-col
        cols="12"
      ...
      >
        <b-form-checkbox
          ...
          inline
        >
          <span>{{$t('Email me hen someone follows me')}}</span>
        </b-form-checkbox>
      </b-col>
      ...
      >
        <b-form-checkbox
          ...
          inline
        >
          <span>{{$t('News and announcements')}}</span>
        </b-form-checkbox>
      </b-col>
      <b-col
        cols="12"
      ...
      >
        <b-form-checkbox
          ...
          inline
        >
          <span>{{$t('Weekly product updates')}}</span>
        </b-form-checkbox>
      </b-col>
      <b-col
        cols="12"
      ...
      >
        <b-form-checkbox
          ...
          inline
        >
          <span>{{$t('Weekly blog digest')}}</span>
        </b-form-checkbox>
      </b-col>
      <!--/ application switch -->
