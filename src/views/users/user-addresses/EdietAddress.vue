...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      await axios
        .get(`${this.$baseUrl}/product/address/${this.$route.params.id}/`,params)
        .then((res) => {
          console.log('EditAddress data',res)
            this.address_address = res.data.address;
            this.address_entrance = res.data.entrance;
            this.address_floor = res.data.floor;
            this.address_flat = res.data.flat;
            this.address_landmark = res.data.landmark;
            this.address_note = res.data.note;
            this.address_lat = res.data.lat;
            this.address_long = res.data.long;
            this.address_is_permament = res.data.is_permament;
            this.busy = false;
        });
    },
    async changeAddress() {
