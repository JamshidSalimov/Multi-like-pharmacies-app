    ...
    <b-form @submit.prevent="createUser">
      <b-card>
        <b-row>
          ...
          <!-- User Name -->
          <b-col cols="12">
            <b-form-group :label="$t('Name')" label-cols-md="4" label-for="Name">
              <b-form-input
                id="Name"
          ...
          <!-- User last name -->
          <b-col cols="12">
            <b-form-group :label="$t('Last name')" label-cols-md="4" label-for="Last_name">
              <b-form-input
                id="Last_name"
          ...
          <!-- Brithday -->
          <b-col cols="12">
            <b-form-group :label="$t('Brithday')" label-cols-md="4" label-for="Brithday">
              <b-form-input
                id="Brithday"
          ...
          <!-- Address -->
          <b-col cols="12">
            <b-form-group :label="$t('Address')" label-cols-md="4" label-for="Address">
              <b-form-input
                id="Address"
          ...
          <!-- Location -->
          <b-col cols="12">
            <b-form-group :label="$t('Location')" label-cols-md="4" label-for="Location">
              <b-form-input
                id="Location"
          ...
          <!-- ill_history -->
          <b-col cols="12">
            <b-form-group :label="$t('Ill history')" label-cols-md="4" label-for="ill_hestory">
              <b-form-input
                id="ill_hestory"
          ...
          <!-- finance_sum -->
          <b-col cols="12">
            <b-form-group :label="$t('Finance sum')" label-cols-md="4" label-for="finance_sum">
              <b-form-input
                id="finance_sum"
          ...
          <!-- Is Active -->
          <b-col cols="12">
          <b-form-group :label="$t('Is active')" label-cols-md="4" label-for="is_active">
            <b-form-checkbox
              id="is_active"
          ...
          <!-- is_superuser -->
          <b-col cols="12">
            <b-form-group :label="$t('Is superuser')" label-cols-md="4" label-for="is_superuser">
                <b-form-checkbox
                id="is_superuser"
          ...
          <!-- is_staff -->
          <b-col cols="12">
            <b-form-group :label="$t('Is staff')" label-cols-md="4" label-for="is_staff">
                <b-form-checkbox
                id="is_staff"
...
export default {
  ...
  methods: {
    changeInput(){
        ...
        console.log("this_number=",this.user_number)
        console.log("this_user.phone_number",this.user_phone_number)
