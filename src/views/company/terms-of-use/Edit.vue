              ...
              >
                <b-tabs pills align="left">
                  <b-tab title="Uz" active>
                    <quill-editor
                      v-model="terms_of_use_uz"
                      :options="snowOption"
                    />
                  </b-tab>
                  <b-tab title="Ру">
                    <quill-editor
                      v-model="terms_of_use_ru"
                      :options="snowOption"
                    />
                  </b-tab>
                  <b-tab title="En">
                    <quill-editor
                      v-model="terms_of_use_en"
                      :options="snowOption"
                    />
                  </b-tab>
                </b-tabs>
  ...
  methods: {
    ...
    async getData() {
      await axios
        ...
        .then((res) => {
          this.terms = res.data;
          this.terms_of_use_uz = this.terms.terms_of_use_uz;
          this.terms_of_use_ru = this.terms.terms_of_use_ru;
          this.terms_of_use_en = this.terms.terms_of_use_en;
