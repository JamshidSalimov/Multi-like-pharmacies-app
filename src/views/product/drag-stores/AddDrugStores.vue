<template>
    <b-form @submit.prevent="AddDrugStore">
        <b-card>
            <b-row>
                <!-- Drug Store Name -->
                <b-col lg="12">
                    <b-form-group :label="$t('Drug Store name')" label-cols-md="4">
        ...
        <b-card>
            <b-row>
                <!-- Category -->
                <b-col cols="12">
                    <b-form-group :label="$t('Drug store category')" label-for="drug_catogory" label-cols-md="4"
                        class="m-0">
        ...
        async getData() {
            await axios
                ...
                .then((res) => {
                    ...
                    // }
                    // console.log("Salommm", this.category)
                });
        },
        setCategory(item) {
