                ...
                <b-row>
                    ...
                    <b-col cols="12">
                        <b-form-group class="m-0" :label="$t('Category')" label-for="h-catogory" label-cols-md="4">
                            <v-select id="h-catogory" disabled :value="selectedCategory" label="name"
                                :options="category">
                                <template #selected-option="{ name }">
                                    {{ name }}
                                </template>
                    ...
                    <b-col cols="12">
                        <b-form-group :label="$t('Type')" label-for="h-type" label-cols-md="4" class="m-0">
                            <v-select id="h-type" :value="selectedType" label="title" :options="type"
                                :placeholder="$t('Type')" @input="setType">
                    ...
                    <b-col cols="12">
                        <b-form-group :label="$t('Brand')" label-for="h-brand" label-cols-md="4" class="m-0">
                            <v-select id="h-brand" :value="selectedBrand" label="title" :options="brand"
                                :placeholder="$t('Brand')" @input="setBrand">
                                <template #selected-option="{ title }">
                                    {{ title }}
                                </template>
                            </v-select>
                    ...
                    <b-col lg="12">
                        <b-form-group :label="$t('Drug price')" label-for="drugPrice" label-cols-md="4" class="m-0">
                            <b-form-input :type="'number'" id="drugPrice" :placeholder="$t('Drug price')"
        ...
        <b-card>
            <b-form-group :label="$t('Drug img')" label-cols-md="4">
                ...
                <img class="mt-1" v-if="mainImageUrl" :src="mainImageUrl" data-fancybox-image="mainImageUrl"
                    alt="main Image" style="height: 150px; object-fit: contain" />
